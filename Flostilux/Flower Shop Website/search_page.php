...
<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="Поиск..." name="search_box">
   ...
   <div class="box-container">
      ...
      <?php
        if(isset($_POST['search_btn'])){
         ...
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%{$search_box}%'") or die('Запрос не удался!');
      ...
      <?php
                ...
                echo '<p class="empty">Не найдено!</p>';
            }
        }else{
            echo '<p class="empty">Что вы пытаетесь найти?</p>';
        }
      ?>
   </div>
</section>
